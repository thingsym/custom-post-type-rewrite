...
class Custom_Post_Type_Rewrite__Post_Type_Rewrite_Slug_With_Front_Test extends WP_UnitTestCase {
	...
	function rewrite_case_1() {
		...
		$this->assertArrayHasKey( 'archives/abc/date/([0-9]{4})/([0-9]{1,2})/([0-9]{1,2})/feed/(feed|rdf|rss|rss2|atom)/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/date/([0-9]{4})/([0-9]{1,2})/([0-9]{1,2})/(feed|rdf|rss|rss2|atom)/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/date/([0-9]{4})/([0-9]{1,2})/([0-9]{1,2})/page/?([0-9]{1,})/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/date/([0-9]{4})/([0-9]{1,2})/([0-9]{1,2})/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/date/([0-9]{4})/([0-9]{1,2})/feed/(feed|rdf|rss|rss2|atom)/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/date/([0-9]{4})/([0-9]{1,2})/(feed|rdf|rss|rss2|atom)/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/date/([0-9]{4})/([0-9]{1,2})/page/?([0-9]{1,})/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/date/([0-9]{4})/([0-9]{1,2})/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/date/([0-9]{4})/feed/(feed|rdf|rss|rss2|atom)/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/date/([0-9]{4})/(feed|rdf|rss|rss2|atom)/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/date/([0-9]{4})/page/?([0-9]{1,})/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/date/([0-9]{4})/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/author/([^/]+)/feed/(feed|rdf|rss|rss2|atom)/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/author/([^/]+)/(feed|rdf|rss|rss2|atom)/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/author/([^/]+)/page/?([0-9]{1,})/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/author/([^/]+)/?$', $wp_rewrite->rules );
		$this->assertArrayHasKey( 'archives/abc/?$', $wp_rewrite->rules );
